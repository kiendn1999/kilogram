...
import 'package:app_cnpm/blocs/login_bloc.dart';
import 'package:app_cnpm/events/authentication_event.dart';
import 'package:app_cnpm/events/login_event.dart';
import 'package:app_cnpm/pages/buttons/login_button.dart';
import 'package:app_cnpm/pages/buttons/signup1_button.dart';
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        width: double.infinity,
                        child: SignUpButton1(userRepository: widget._userRepository),
                      ),
                    ),
                  ],
                );
